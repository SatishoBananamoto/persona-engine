...
| TF-002 | **FIXED** | confidence | Confidence distribution collapsed — 100% of population below 0.4 | Architectural fix (CF-1/2/3/4): self-efficacy baseline, proficiency as bonus not foundation, personality modifier capped ±0.10, floors removed. Population now mean=0.39, range=[0.29, 0.48], 0 floor hits. |
